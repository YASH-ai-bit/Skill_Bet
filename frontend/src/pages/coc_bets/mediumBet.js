...
const MediumBet = () => {
    ...
    const [destructionPercentage, setDestructionPercentage] = useState(85);
    ...
    const handlePlaceBet = async () => {
        ...
        if (destructionPercentage < 80 || destructionPercentage > 100) {
            alert('Please enter a valid destruction percentage (80-100%)');
            return;
        }

        if (!betAmount || betAmount < 0.025) {
            alert('Please enter a valid bet amount (minimum 0.025 ETH)');
            return;
        }
    ...
    const handleSeeResults = () => {
        ...
        navigate(`/coc-bets/results/medium`, {
            state: {
                clanTag,
                expectedDestructionPercentage: Number(destructionPercentage),
        ...
        <div className="min-h-screen pt-16 bg-gray-900">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="flex items-center mb-8">
                    <Link
                        to="/coc-bets"
                        className="flex items-center text-gray-400 hover:text-blue-500 transition-colors mr-4"
                    >
                        <ArrowLeftIcon className="h-5 w-5 mr-1" />
                        <span>Back</span>
                    </Link>
                    <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500 pb-1">
                        Medium Challenge
                    </h1>
                </div>
                ...
                <motion.div
                    ...
                    className="bg-gray-800 rounded-xl p-6 mb-8 border border-blue-500/30"
                >
                    ...
                    {showInfo && (
                        ...
                        >
                            <p>Medium challenges are designed for experienced Clash of Clans players. The requirements are more demanding, but the payout is higher.</p>
                            <p className="mt-2">Our system tracks your game performance in real-time through the Clash of Clans API.</p>
                        </motion.div>
                    )}
                        ...
                        <ul className="space-y-2">
                            {challengeRequirements.map((req, index) => (
                                <li key={index} className="flex items-start">
                                    <span className="inline-flex items-center justify-center h-5 w-5 rounded-full bg-blue-500/20 text-blue-500 text-xs mr-3 mt-0.5">
                                        ✓
                                    </span>
                    ...
                    <div className="mb-6">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full bg-gray-700 border border-gray-600 rounded-lg py-2 px-8 text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div className="mb-6">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full bg-gray-700 accent-blue-500 h-2 rounded-lg appearance-none cursor-pointer"
                                disabled={betPlaced}
                            />
                    ...
                    <div className="mb-6">
                        <div className="flex justify-between mb-2">
                            ...
                            <span className="text-gray-400 text-sm">Min: 0.025 ETH</span>
                        </div>
                        <div className="relative">
                    ...
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p className="text-xl font-bold text-blue-500">
                                {betAmount ? (Number(betAmount) * 4).toFixed(2) : '0.00'} ETH
                            </p>
                        </div>
                        <div>
                            <p className="text-gray-400 text-sm">Payout Ratio</p>
                            <p className="text-xl font-bold text-white">4x</p>
                        </div>
                    </div>
                    ...
                    <motion.button
                        ...
                        className={`w-full font-bold py-3 px-4 rounded-lg ${isPlacingBet ? 'opacity-70 cursor-not-allowed' : ''
                            } ${betPlaced
                    ...
                    {success && (
                        ...
                        >
                            <p className="text-blue-400 font-medium">Bet placed successfully! Complete the challenge to win.</p>
                        </motion.div>
                    )}
                </motion.div>
                ...
                >
                    ...
                    {betPlaced && (
                        <p className="mt-2 text-blue-400">Challenge active! Return to this page to check your results after completing the required battles.</p>
                    )}
                </motion.div>
            </div>
        </div>
